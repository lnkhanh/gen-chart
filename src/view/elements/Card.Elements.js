...
export function EyeIcon({card_dim,x,y}) {
  return (`
    <g transform="translate(${x || card_dim.w-20},${y || card_dim.h-20})scale(.04)" style="cursor: pointer" fill="currentColor" class="card_edit eye_icon">
